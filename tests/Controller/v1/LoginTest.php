...
class LoginTest extends WebTestCase
{
     ...
     * @var string
     */
    private string $loginUrl = 'http://localhost/api/v1/login';
    /**
     * @var string
     */
    ...
    /**
     * @dataProvider \App\DataProvider\v1\LoginDataProvider::provideLoginRequest
     * @param $loginRequest
     */
    #[NoReturn]
    public function testLoginSuccess($loginRequest)
    {
        ...
        $loginRequest['login']['appId'] = $applicationContent['appId'];
        $loginRequest['register']['appId'] = $applicationContent['appId'];
        $this->client->request(
            Request::METHOD_POST,
            $this->registerUrl,
            [],
            [],
            [],
            json_encode($loginRequest['register'])
        );
        $this->client->request(
            Request::METHOD_POST,
            $this->loginUrl,
            ...
            [],
            [],
            json_encode($loginRequest['login'])
        );
